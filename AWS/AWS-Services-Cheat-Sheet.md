...
| [Macie](https://docs.aws.amazon.com/macie/?id=docs_gateway)  | Uses ML to help identify sensitive data.                     |
...
| [Rekognition](https://docs.aws.amazon.com/rekognition/?id=docs_gateway) | Object, people, text, scene, activity recognition for images and video. |
...
| [CloudTrail](https://docs.aws.amazon.com/cloudtrail/?id=docs_gateway) | Trace API calls to users or IP.                              |
...
| [Systems Manager](https://docs.aws.amazon.com/systems-manager/?id=docs_gateway) | Operations & Application Management, Actions & Change, Instances & Nodes, and Shared Resources. |
...
| [Schema Conversion Tool](https://docs.aws.amazon.com/SchemaConversionTool/?id=docs_gateway) | Converts database schema and code for use with target.       |
...
| [CloudFront](https://docs.aws.amazon.com/cloudfront/?id=docs_gateway) | Content delivery network (CDN)                               |
...
| [EMR](https://docs.aws.amazon.com/emr/?id=docs_gateway)      | *Elastic Map/Reduce* - Run and scale big data frameworks.    |
...
| [QuickSight](https://docs.aws.amazon.com/quicksight/?id=docs_gateway) | Scalable analytics service that can build visualizations and insights. |
...
| Service                                                      | Description |
| ------------------------------------------------------------ | ----------- |
| [Managed Blockchain](https://docs.aws.amazon.com/managed-blockchain/?id=docs_gateway) |             |
